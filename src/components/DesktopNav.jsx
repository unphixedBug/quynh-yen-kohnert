...
export default function DesktopNav() {
  return (
    <nav className="hidden lg:fixed lg:flex lg:flex-col lg:w-[103px] lg:h-screen lg:items-start lg:ml-[2.25rem] lg:justify-between bg-light z-50">
      <div>
        <Link to="/">
          <svg
            version="1.1"
      ...
      <ul className="lg:flex lg:flex-col lg:gap-10 text-[1.1rem] text-dark">
        <li>
          <Link
            to="/creations"
      ...
      <div className="lg:flex lg:flex-col lg:items-start lg:pb-[2rem] lg:gap-4">
        <a
